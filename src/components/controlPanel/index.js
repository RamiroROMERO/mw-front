...
const ControlPanel = (props) => {
  const { fnNew = null, fnSearch = null, fnSave = null, fnPrint = null, fnDelete = null, fnCancel = null, buttonsHome = [], buttonsOptions = [],
    buttonsAdmin = [], activeTabDefault = '1', disableTab = [false, false, false] } = props;
    ...
    <>
      ...
      <TabContent activeTab={activeTab}>
        <TabPane tabId="1">
          ...
          {fnDelete ? <Button color="light" className="btn-control-panel" onClick={fnDelete}><i className="bi bi-trash" /><br /> {IntlMessages('button.delete')}</Button> : ""}
