...
const DetailPayment = ({employeeName, date, value, noQuotes, valueQuote, startDate, description, notes, onInputChange, formValidation, sendForm, setBulkForm}) => {

  const {dateValid, descriptionValid, valueValid, valueQuoteValid, startDateValid} = formValidation;
