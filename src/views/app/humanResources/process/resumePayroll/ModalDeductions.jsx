...
import { useModalDeductions } from './useModalDeductions'

const ModalDeductions = ({data, setOpen}) => {
  const {idPayroll, dataDetailPayroll, listTypeDeductions, setLoading, fnViewDetailPayroll} = data;

  const {formState, formValidation, sendForm, onInputChange, table, fnSave} = useModalDeductions({idPayroll, dataDetailPayroll, setLoading, setOpen, fnViewDetailPayroll, listTypeDeductions});
...
export default ModalDeductions