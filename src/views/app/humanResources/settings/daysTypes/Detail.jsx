...
const Detail = ({formState, listAccount, formValidation, onInputChange, sendForm, fnClear, fnSaveDocument}) => {
  const {name, noAccount, status} = formState;
      ...
      <CardBody>
        <Row>
          ...
          <Colxx xxs={12}>
            <SearchSelect
              name="noAccount"
              inputValue={noAccount}
              onChange={onInputChange}
              options={listAccount}
              label="input.ctaAccount"
            />
          </Colxx>
