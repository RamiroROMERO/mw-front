...
const Managers = (props) => {
  ...
  const { id, name, dni, phone, email, status } = formState;
  ...
  const [table, setTable] = useState({
    title: IntlMessages("page.managers.table.title"),
    columns: [
      { text: IntlMessages("page.managers.table.dni"), dataField: "dni", headerStyle: { 'width': '15%' } },
      { text: IntlMessages("page.managers.table.name"), dataField: "name", headerStyle: { 'width': '40%' } },
      {
        text: IntlMessages("page.managers.table.phone"), dataField: "phone", headerStyle: { 'width': '15%' },
        classes: 'd-xs-none-table-cell', headerClasses: 'd-xs-none-table-cell'
      },
      { text: IntlMessages("page.managers.table.status"), dataField: "statusColor", headerStyle: { 'width': '10%' } },
  ...
  return (
    <>
      <Row>
        <Colxx xxs="12" xs="12" sm="12" md="12" lg="4" xl="4">
          <Card className="mb-5">
            <CardBody>
              <Form>
                <Row>
                  ...
                  <Colxx xxs="12" sm="6" lg="12">
                    <InputField
                      ...
                      onChange={onInputChange}
                      type="text"
                      label="page.managers.input.name"
                ...
                <Row>
                  <Colxx xxs="12" sm="6" lg="12">
                    <InputField
                      ...
                      onChange={onInputChange}
                      type="text"
                      label="page.managers.input.phone"
                    />
                  </Colxx>
                  <Colxx xxs="12" sm="6" lg="12">
                    <InputField
                      ...
                      onChange={onInputChange}
                      type="text"
                      label="page.managers.input.email"
                    />
                  </Colxx>
                </Row>
                <Row>
                  <Colxx xxs="12">
                    <Checkbox
                      ...
                      name="status"
                      value={status}
                      label="page.managers.check.status"
                    />
                  </Colxx>
                </Row>
                <Row>
        ...
        <Colxx xxs="12" xs="12" sm="12" md="12" lg="8" xl="8">
          <ReactTable
            {...table}
          />
        </Colxx>
