...
const OrdersTypes = (props) => {
  const { setLoading } = props;
  const [currentItem, setCurrentItem] = useState({});
  const [openMsgQuestion, setOpenMsgQuestion] = useState(false);
  const [sendForm, setSendForm] = useState(false);

  const ordersTypesValid = {
  ...
  const [table, setTable] = useState({
    title: IntlMessages("page.ordersTypes.table.title"),
    columns: [
      { text: IntlMessages("page.ordersTypes.table.name"), dataField: "name", headerStyle: { 'width': '30%' } },
      { text: IntlMessages("page.ordersTypes.table.description"), dataField: "description", headerStyle: { 'width': '35%' } },
      { text: IntlMessages("page.ordersTypes.table.status"), dataField: "statusColor", headerStyle: { 'width': '20%' } },
                ...
                <Row>
                  <Colxx xxs="12" sm="6" lg="12">
                    <InputField
                      ...
                      type="text"
                      label="page.ordersTypes.input.name"
                  ...
                  <Colxx xxs="12" sm="6" lg="12">
                    <InputField
                      ...
                      onChange={onInputChange}
                      type="text"
                      label="page.ordersTypes.input.description"
                    />
                  </Colxx>
                </Row>
                <Row>
                  <Colxx xxs="12">
                    <Checkbox
                      ...
                      name="status"
                      value={status}
                      label="page.ordersTypes.check.status"
                    />
                  </Colxx>
                </Row>
                <Row>
