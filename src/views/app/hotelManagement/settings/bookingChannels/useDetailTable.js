...
export const useDetailTable = ({ dataChannels, onBulkForm, setOpenMsgQuestion, fnDelete, currentPage, totalPages, setCurrentPage, setSearch }) => {
  ...
  const [table, setTable] = useState({
    title: IntlMessages("page.hotel.table.bookingChannels"),
    columns: [
  ...
  useEffect(()=>{
    const tableData = {
      ...table, data: dataChannels, options: {totalPages, currentPage, setCurrentPage, typePagination: 2, setSearch}
    }
    setTable(tableData);
  },[dataChannels]);
