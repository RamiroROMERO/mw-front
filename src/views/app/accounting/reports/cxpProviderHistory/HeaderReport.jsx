...
const HeaderReport = ({ providerId, dateStart, dateEnd, listProviders, onInputChange, fnSearch, fnExportXlsx, fnLoadProviders }) => {
  return (
    <>
      <Row>
        <Colxx xxs="12" md="6" lg="5">
          <SearchSelect
            label="page.cxpProviderHistory.input.provider"
            name="providerId"
