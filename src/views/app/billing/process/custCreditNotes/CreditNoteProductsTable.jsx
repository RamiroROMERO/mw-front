...
const CreditNoteProductsTable = (props) => {
  const { detail2, originInvoice, fnSeekOriginInvoice, onChangeDetail2Qty, fnDeleteDetail2Row, disabled } = props;
    ...
    <Form>
      <Row className="mb-2">
        ...
        <Colxx xxs="12" sm="6" lg="8">
          {originInvoice && (
            <span>
              <strong>{IntlMessages("page.custCreditNotes.input.originInvoice")}:</strong> {originInvoice.invoiceNumber}
      ...
      <Row>
        <Colxx xxs="12">
          <ContainerWithLabel label="page.custCreditNotes.title.productsDetail">
            <Table bordered hover size="sm">
              <thead>
                <tr>
                  <th>{IntlMessages("page.invoicing.table.code")}</th>
                  <th>{IntlMessages("page.invoicing.input.descriptionProd")}</th>
                  <th>{IntlMessages("page.custCreditNotes.table.qtyInvoiced")}</th>
                  <th>{IntlMessages("page.custCreditNotes.table.qtyReturn")}</th>
                  <th>{IntlMessages("page.invoicing.input.subtotal")}</th>
                  <th>{IntlMessages("page.invoicing.input.discValue")}</th>
