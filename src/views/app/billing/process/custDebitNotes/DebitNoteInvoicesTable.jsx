...
const DebitNoteInvoicesTable = (props) => {
  ...
  return (
    <Form>
          ...
          <>
            <Colxx xxs="7" sm="3" lg="2">
              <InputField
                ...
                label="page.custDebitNotes.input.percentToApply"
      ...
      <Row>
        <Colxx xxs="12">
          <ContainerWithLabel label="page.custDebitNotes.title.invoicesDetail">
            <Table bordered hover size="sm">
              <thead>
                <tr>
                  <th>{IntlMessages("page.custDebitNotes.table.date")}</th>
                  <th>{IntlMessages("page.custDebitNotes.table.invoice")}</th>
                  <th>{IntlMessages("page.custDebitNotes.table.balance")}</th>
                  <th>{IntlMessages("page.custDebitNotes.table.percent")}</th>
                  <th>{IntlMessages("page.custDebitNotes.table.valueToApply")}</th>
...
export default DebitNoteInvoicesTable;
