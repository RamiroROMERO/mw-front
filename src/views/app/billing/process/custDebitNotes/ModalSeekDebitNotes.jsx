...
const TYPE_LABELS = {
  1: 'page.custDebitNotes.radio.lateFee',
  2: 'page.custDebitNotes.radio.otherCharge',
  3: 'page.custDebitNotes.radio.adjustment',
  4: 'page.custDebitNotes.radio.other'
};

const ModalSeekDebitNotes = ({ data, setOpen }) => {
  const { dataDebitNotes, fnView } = data;

  const rows = dataDebitNotes.map((item) => ({
    ...item,
  ...
  const table = {
    title: IntlMessages("page.custDebitNotes.modal.search.title"),
    columns: [
      ...
      { text: IntlMessages("page.custDebitNotes.title.type"), dataField: "typeName", headerStyle: { width: '10%' } },
...
export default ModalSeekDebitNotes;
